      ...
      <div className="small-10">
        ...
        <div className="row about-img">
          <div className="medium-6 small-12 columns">
            <img src="./public/img/band-nursinghome.jpg" alt="musicians playing" />
          </div>
          <div className="medium-6 small-12 columns">
            <img src="./public/img/IMG_8306.jpg" alt="code for denver" />
          </div>
        </div>
        ...
        <p>
          <strong>Vision: </strong>The name “EncoreLink” is a reflection
           of our mission and vision that the musicians keep coming back and
            play more encores through the link between the musicians and the facilities.</p>
        <p>
          <strong>Major Partners: </strong>Encore Link is created and currently maintained
           by <a href="https://www.codefordenver.org/" target="_blank" rel="noopener noreferrer">Code for Denver</a>,
            a volunteer-driven community outreach that is committed to improving lives through
             technology. Many current students and graduates of the
              <a href="https://www.du.edu/lamont" target="_blank" rel="noopener noreferrer"> Lamont School of Music </a>
               have volunteered through individual community outreach and now they are helping
                us launch EncoreLink in Denver, Colorado. Many thanks to the volunteers at Code
                 for Denver for helping us build this incredible web platform!</p>
      </div>
    </div>
  );
}
